...
class Receipt(models.Model):
    ...
    total_recieved = models.FloatField(null=True, blank=True)
...
class ReceiptLineItem(models.Model):
    ...
    invoice_full_amount = models.FloatField(null=True, blank=True)
    invoice_amount_remain = models.FloatField(null=True, blank=True)
    ...
    class Meta:
        ...
        managed = False
    def __str__(self):
        return '{"receipt_no":"%s","item_no":"%s","invoice_no":"%s","invoice_date":%s,"amount_paid_here":"%s"}' % (self.invoice_no, self.item_no, self.invoice_no, self.invoice_date, self.amount_paid_here)
